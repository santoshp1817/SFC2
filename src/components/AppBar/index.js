...
const useStyles = makeStyles((theme) => ({
  ...
  appBar: {
    ...
    backgroundImage:
      "url('https://images.pexels.com/photos/929382/pexels-photo-929382.jpeg?cs=srgb&dl=pexels-chris-leboutillier-929382.jpg&fm=jpg')",
  },
  appBarShift: {
  ...
  backGround: {
    ...
    backgroundImage:
      "url('https://images.pexels.com/photos/3044479/pexels-photo-3044479.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')",
  },
  navbarContainer: {
    display: 'flex',
    alignItems: 'center',
...
export default function ButtonAppBar({ data }) {
  ...
  const [selectComp, setSelectComp] = useState('Home')
  ...
  // useEffect(() => {
  //   console.warn('pp', params.value, location.pathname)
  //   // if (params.value === 'dashboard') {
  //   //   setShowComp('dashboard')
  //   // }
  //   if (location !== '/home') {
  //     // setInitial(false)
  //   }
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar className={classes.backGround}>
          ...
          <div onClick={() => setShowComp('Home')} style={{ display: 'flex', cursor: 'pointer' }}>
